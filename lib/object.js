 ...
 * @returns {Function}
 */
GSObject.extend = function gsExtend(childClass) {
  ...
  childObject.extend = parentObject.extend.bind(childObject);
  childObject.create = parentObject.create.bind(childObject);
  childObject.createWithMixins = parentObject.createWithMixins.bind(childObject);
  return childObject;
};
